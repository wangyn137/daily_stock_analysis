...
# ===== Re-exports from config_types (canonical source) =====
# fmt: off
from src.config_types import (  # noqa: E402,F401
...
class Config:
    ...
    realtime_source_priority: str = "westock,tencent,akshare_sina,efinance,akshare_em"
    # 实时行情缓存时间（秒）
    ...
    def _resolve_realtime_source_priority(cls) -> str:
        ...
        default_priority = 'westock,tencent,akshare_sina,efinance,akshare_em'
